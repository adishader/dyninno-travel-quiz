  ...
  return (
    <ResultScreen
      ...
      copy={{
        ...
        brackets: {
          1: { title: dict["result1.title"], description: dict["result1.description"] },
          2: { title: dict["result2.title"], description: dict["result2.description"] },
          3: { title: dict["result3.title"], description: dict["result3.description"] },
        },
      }}
    />
  );
